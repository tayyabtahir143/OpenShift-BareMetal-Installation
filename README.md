...
---
## Important: *OpenShift installation depends on these 2 DNS records, they should be redirected to haproxy, and haproxy should redirect them to all master nodes.*
